...
// to destination
void tracePath(cell cellDetails[][COL], Pair dest,char grid[ROW][COL])
{
    cout<<"\nThe Path is "<<endl;
    int row = dest.first;
    int col = dest.second;
    cout<< row <<" "<<col<<endl;
        ...
        int tempr = cellDetails[row][col].parent_i;
        int tempc = cellDetails[row][col].parent_j;


    cout<<cellDetails[tempr][tempc].g+1.0<<endl;
...
void aStarSearch(char grid[ROW][COL], Pair start, Pair dest)
{
    ...
    **/
    while (!openList.empty())
    {
        ...
        //cout<<"The current i,j cell "<<i<<","<<j<<" fval is "<<p.first<<endl;
